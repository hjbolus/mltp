...
"""Tests for the proofs module."""
from mltp.predicates import *
from mltp.propositions import Formula as PropositionalFormula
from mltp.logic_utils import frozendict
# formula,templates,constant_and_variable_instantiation_map,relations_instantiation_map,instance = (Formula.parse('R(c)'), {'c'}, {'c': Term('9')}, {},  'R(9)')
...
def test_instantiate_helper(debug=False):
    for     formula,                                    templates, constant_and_variable_instantiation_map, relations_instantiation_map,                instance in [
            ...
            ('(R(0)&R(x))',                             {'R'},           {},                                {'R': Formula.parse('_=1')},                  '(0=1&x=1)'),
            ('(RQ(0)|RQ(x))',                           {'RQ'},          {},                                {'RQ': Formula.parse('1=1')},                 '(1=1|1=1)'),
            ('(R(0)->Q())',                             {'R'},           {},                                {'R': Formula.parse('_=1'), 'Q': Formula.parse('1=1')}, '(0=1->1=1)'),
            ('(Ax[R(x)]->R(c))',                        {'c', 'R'},      {'c': Term('9')},                  {'R': Formula.parse('(Q(y)|_=0)')},           '(Ax[(Q(y)|x=0)]->(Q(y)|9=0))'), #(Ax[(Q(y)|x=0)]->(Q(y)|c=0))
            ('((R(0)&Az[(R(z)->R(s(z)))])->Az[R(z)])',  {'R'},           {},                                {'R': Formula.parse('plus(x,_)=plus(_,x)')},  '((plus(x,0)=plus(0,x)&Az[(plus(x,z)=plus(z,x)->plus(x,s(z))=' + 'plus(s(z),x))])->Az[plus(x,z)=plus(z,x)])'),
            ('Ax[R(x)]',                                {'R'},           {},                                {'R': Formula.parse('_=1')},                  'Ax[x=1]'),
            ('Ax[R(x)]',                                {'R', 'x'},      {'x': Term('z')},                  {'R': Formula.parse('_=x')},                  'Az[z=x]'),
            ('Ev[u=f(v)]',                              {'v'},           {'v': Term('x')},                  {},                                           'Ex[u=f(x)]'),
            ('(Ax[R(x)]->R(c))',                        {'c', 'x', 'R'}, {},                                {},                                           '(Ax[R(x)]->R(c))'),
            ('(Ax[R(x)]->Ay[R(y)])',                    {'x', 'y'},      {'x': Term('z'), 'y': Term('z')},  {},                                           '(Az[R(z)]->Az[R(z)])'),
            ('(Ax[R(x)]->Ay[R(y)])',                    {'x', 'y'},      {'x': Term('y'), 'y': Term('y')},  {},                                           '(Ay[R(y)]->Ay[R(y)])'),
            ('(Ax[R(x)]->Ay[R(y)])',                    {'x', 'y'},      {'x': Term('y'), 'y': Term('x')},  {},                                           '(Ay[R(y)]->Ax[R(x)])'),
            ('(Ax[R(x)]->Ay[R(y)])',                    {'x', 'y'},      {'x': Term('y'), 'y': Term('z')},  {},                                           '(Ay[R(y)]->Az[R(z)])'),
            ('(Ax[R(x)]->Ay[R(y)])',                    {'x', 'y'},      {'x': Term('y'), 'y': Term('z')},  {'R': Formula.parse('R(3,_)')},               '(Ay[R(3,y)]->Az[R(3,z)])'),
            ('(Axy[R(xy)]->R(c))',                      {'xy', 'c', 'R'},{'xy': Term('z'), 'c': Term('z')}, {'R': Formula.parse('Ay[(L(x,y)->L(_,x))]')}, '(Az[Ay[(L(x,y)->L(z,x))]]->Ay[(L(x,y)->L(z,x))])'),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))',      {'R', 'Q', 'x'}, {},                                {'Q':Formula.parse('z=0')},                   '(Ax[(z=0->R(x))]->(z=0->Ax[R(x)]))')
]:
        ...
        if debug:
            print('... yields', result)
        assert str(result) == instance, print(' expected ', instance)
    ...
    for     formula,                            templates,  constant_and_variable_instantiation_map,relations_instantiation_map,variable_name,relation_name in [
            ...
            ('Ax[Q(0)]',                           {'Q', 'x'},      {'x': Term('z')}, {'Q':Formula.parse('z=1')},               'z', 'Q'),
            ('(Ax[R(x)]->R(c))',                   {'R','x','c'},   {},               {'R':Formula.parse('Ex[_=7]')},           'x', 'R'),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'}, {},               {'Q':Formula.parse('x=0')},               'x', 'Q'),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'}, {'x': Term('z')}, {'Q':Formula.parse('z=0')},               'z', 'Q')
]:
        formula = Formula.parse(formula)
        schema = Schema(formula, frozenset(templates))
        if debug:
...
def test_instantiate(debug=False):
    for formula,templates,instantiation_map,instance in [
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'},{'Q':Formula.parse('x=0'), 'x':'z'},'(Az[(x=0->R(z))]->(x=0->Az[R(z)]))'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'},{'x':'z', 'R':Formula.parse('Q(_,x)')},'(Az[Q(z,x)]->Q(c,x))'),
            ('(Ax[R(x)]->R(c))', {'x', 'c', 'R'},{'x':'z', 'c':Term('z'),'R':Formula.parse('Ay[(L(x,y)->L(_,x))]')},'(Az[Ay[(L(x,y)->L(z,x))]]->Ay[(L(x,y)->L(z,x))])'),
            ('(Axxx[RRR(xxx)]->Eyyy[QQQ(yyy)])', {'RRR', 'yyy'},{'RRR':Formula.parse('_=yyy'), 'yyy':'xxx'},'(Axxx[xxx=yyy]->Exxx[QQQ(xxx)])'),
            ('R(c)', {'c'}, {'c':Term('9')}, 'R(9)'),
            ('~R(cd)', {'cd'}, {'cd': Term('9')},  '~R(9)'),
            ('(R(0)&R(x))', {'R'}, {'R':Formula.parse('_=1')},'(0=1&x=1)'),
            ('(R(0)|R(x))', {'R'}, {'R':Formula.parse('1=1')},'(1=1|1=1)'),
            ('(R(0)->Q())', {'R', 'Q'}, {'R':Formula.parse('_=1'), 'Q':Formula.parse('1=1')},'(0=1->1=1)'),
            ('(Ax[R(x)]->R(c))', {'c', 'R'},{'R':Formula.parse('(Q(y)|_=0)'), 'c':Term('9')},'(Ax[(Q(y)|x=0)]->(Q(y)|9=0))'),
            ('((R(0)&Az[(R(z)->R(s(z)))])->Az[R(z)])', {'R'},{'R':Formula.parse('plus(x,_)=plus(_,x)')},'((plus(x,0)=plus(0,x)&Az[(plus(x,z)=plus(z,x)->plus(x,s(z))=' +'plus(s(z),x))])->Az[plus(x,z)=plus(z,x)])'),
            ('Ev[u=f(v)]', {'v'}, {'v': 'x'}, 'Ex[u=f(x)]'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'},{'c':Term('0'), 'x':'y', 'R':Formula.parse('Q(_)')},'(Ay[Q(y)]->Q(0))'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'},{'c':Term('0'), 'x':'y', 'R':Formula.parse('Q(v)')},'(Ay[Q(v)]->Q(v))'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'},{'c':Term.parse('f(g(a),g(a))'), 'x':'x','R':Formula.parse('(_=0|R(_))')},'(Ax[(x=0|R(x))]->(f(g(a),g(a))=0|R(f(g(a),g(a)))))'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'}, {}, '(Ax[R(x)]->R(c))'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'}, {'Q':Formula.parse('_=0')},None),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'},{'R':Formula.parse('Q(0)'), 'a':Term('b')}, None),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'}, {'c':Term.parse('f(x)')},'(Ax[R(x)]->R(f(x)))'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'}, {'c':Term('x'), 'x':'z'},'(Az[R(z)]->R(x))'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'},{'R':Formula.parse('Q(_,z)')}, '(Ax[Q(x,z)]->Q(c,z))'),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'},{'R':Formula.parse('Q(_,x)')}, None),
            ('(Ax[R(x)]->R(c))', {'c', 'x', 'R'},{'c':Term('z'), 'R':Formula.parse('Q(_,z)')},'(Ax[Q(x,z)]->Q(z,z))'),
            ('(Ax[R(x)]->Ay[R(y)])', {'x', 'y'}, {'x':'z', 'y':'z'},'(Az[R(z)]->Az[R(z)])'),
            ('(Ax[R(x)]->Ay[R(y)])', {'x', 'y'}, {'x':'y', 'y':'y'},'(Ay[R(y)]->Ay[R(y)])'),
            ('(Ax[R(x)]->Ay[R(y)])', {'x', 'y'}, {'x':'y', 'y':'x'},'(Ay[R(y)]->Ax[R(x)])'),
            ('(Ax[R(x)]->Ay[R(y)])', {'x', 'y'}, {'x':'y', 'y':'z'},'(Ay[R(y)]->Az[R(z)])'),
            ('(Ax[R(x)]->Ay[R(y)])', {'x', 'y', 'R'},{'x':'y', 'y':'z', 'R':Formula.parse('R(3,_)')},'(Ay[R(3,y)]->Az[R(3,z)])'),
            ('(c1=c2->(R(c1)->R(c2)))', {'c1', 'c2', 'R'},{'c1':Term.parse('f(x)'), 'R':Formula.parse('_=c')},'(f(x)=c2->(f(x)=c->c2=c))'),
            ('(c1=c2->(R(c1)->R(c2)))', {'c1', 'c2', 'R'},{'c2':Term('c1'), 'c1':Term('c2')}, '(c2=c1->(R(c2)->R(c1)))'),
            ('(c1=c2->(R(c1)->R(c2)))', {'c1', 'c2', 'R'},{'R':Formula.parse('R(c1,c2,_)')},'(c1=c2->(R(c1,c2,c1)->R(c1,c2,c2)))'),
            ('(c1=c2->(R(c1)->R(c2)))', {'c1', 'c2', 'R'},{'c1':Term('c2'), 'c2':Term('c1'),'R':Formula.parse('R(c1,c2,_)')},'(c2=c1->(R(c1,c2,c2)->R(c1,c2,c1)))'),
            ('(c1=c2->(R(c1)->R(c2)))', {'c1', 'c2', 'R'},{'R':Formula.parse('(Q(_)&Av[S(v)])')},'(c1=c2->((Q(c1)&Av[S(v)])->(Q(c2)&Av[S(v)])))'),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'},{'Q':Formula.parse('v=0'), 'R':Formula.parse('S(_)')},'(Ax[(v=0->S(x))]->(v=0->Ax[S(x)]))'),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'},{'Q':Formula.parse('v=0'), 'R':Formula.parse('S(_)'),'x':'z'},'(Az[(v=0->S(z))]->(v=0->Az[S(z)]))'),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'},{'Q':Formula.parse('z=0')},'(Ax[(z=0->R(x))]->(z=0->Ax[R(x)]))'),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'},{'Q':Formula.parse('x=0')}, None),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'},{'Q':Formula.parse('Ax[x=0]')},'(Ax[(Ax[x=0]->R(x))]->(Ax[x=0]->Ax[R(x)]))'),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'},{'Q':Formula.parse('z=0'), 'x':'z'}, None),
            ('(Ax[(Q()->R(x))]->(Q()->Ax[R(x)]))', {'R', 'Q', 'x'},{'Q':Formula.parse('Az[z=0]'), 'x':'z'},'(Az[(Az[z=0]->R(z))]->(Az[z=0]->Az[R(z)]))'),
            ('(Axxx[RRR(xxx)]->Eyyy[QQQ(yyy)])', {'RRR', 'yyy'},{'QQQ':Formula.parse('_=0')}, None),
            ('(Axxx[RRR(xxx)]->Eyyy[QQQ(yyy)])', {'RRR', 'yyy'},{'QQQ':Formula.parse('RRR(_)')}, None),
            ('(Axxx[RRR(xxx)]->Eyyy[QQQ(yyy)])', {'RRR', 'yyy'}, {'xxx':'z'},None),
            ('(Ax[R(x)]->R(c))', {'R','x','c'},{'R':Formula.parse('Ex[_=7]')}, None)
            ]:
...
def test_prove_from_skeleton_proof(debug=False):
    from mltp.propositions import prove_tautology as prove_propositional_tautology
    #from proofs import _prove_from_skeleton_proof
    ...
    for formula,skeleton,substitution_map in [
        ...
        proof = _prove_from_skeleton_proof(formula, skeleton_proof,
                                           frozendict(substitution_map))
