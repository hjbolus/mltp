...
#     Test one invocation
    ...
    assert result.assumptions == Prover.AXIOMS.union({Schema(Formula.parse(a)) for a in GROUP_AXIOMS}), print(f'Axioms are {result.assumptions},\n\nAxioms should be {predicates.Prover.AXIOMS.union({predicates.Schema(predicates.Formula.parse(a)) for a in predicates.GROUP_AXIOMS})}\n')
...
#     Test two concurrent invocations
    ...
    for proof,assumption1,assumption2 in [
            (prove_syllogism_all_all(),                                'Ax[(Greek(x)->Human(x))]',             'Ax[(Human(x)->Mortal(x))]'),
            (prove_syllogism_all_all(),                                'Ax[(Human(x)->Mortal(x))]',            'Ax[(Greek(x)->Human(x))]'),
            (prove_syllogism_all_all_with_tautological_implication(),  'Ax[(Greek(x)->Human(x))]',             'Ax[(Human(x)->Mortal(x))]'),
            (prove_syllogism_all_all_with_tautological_implication(),  'Ax[(Human(x)->Mortal(x))]',            'Ax[(Greek(x)->Human(x))]'),
            (prove_syllogism_all_exists(),                             'Ax[(Man(x)->Mortal(x))]',              'Ex[Man(x)]'),
            (prove_syllogism_all_exists(),                             'Ex[Man(x)]',                           'Ax[(Man(x)->Mortal(x))]'),
            (prove_syllogism_all_exists_with_existential_derivation(), 'Ax[(Man(x)->Mortal(x))]',              'Ex[Man(x)]'),
            (prove_syllogism_all_exists_with_existential_derivation(), 'Ex[Man(x)]',                           'Ax[(Man(x)->Mortal(x))]'),
            (prove_lovers(),                                           'Ax[Ey[Loves(x,y)]]',                   'Ax[Az[Ay[(Loves(x,y)->Loves(z,x))]]]'),
            (prove_lovers(),                                           'Ax[Az[Ay[(Loves(x,y)->Loves(z,x))]]]', 'Ax[Ey[Loves(x,y)]]'),
            (prove_homework(),                                         '~Ex[(Homework(x)&Fun(x))]',            'Ex[(Homework(x)&Reading(x))]'),
            (prove_homework(),                                         'Ex[(Homework(x)&Reading(x))]',         '~Ex[(Homework(x)&Fun(x))]'),
            (prove_syllogism(),                                        'Ax[(Man(x)->Mortal(x))]',              'Man(aristotle)'),
            (prove_syllogism(),                                        'Man(aristotle)',                       'Ax[(Man(x)->Mortal(x))]'),
            (prove_syllogism_with_universal_instantiation(),           'Ax[(Man(x)->Mortal(x))]',              'Man(aristotle)'),
            (prove_syllogism_with_universal_instantiation(),           'Man(aristotle)',                       'Ax[(Man(x)->Mortal(x))]')
             ]:
        if (debug):
