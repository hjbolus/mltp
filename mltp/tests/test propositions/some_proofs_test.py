...
from mltp.propositions.some_proofs import *
...
def test_prove_NNE(debug=False):
    from propositions.some_proofs import _NNE, _prove_NNE
...
def test_prove_CP(debug=False):
    from propositions.some_proofs import _CP, _prove_CP
...
def test_prove_CM(debug=False):
    from propositions.some_proofs import _CM, _prove_CM
