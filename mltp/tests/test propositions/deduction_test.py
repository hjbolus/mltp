...
R8 = InferenceRule([Formula.parse('p'), Formula.parse('q')],
                   Formula.parse('(p&q)'))
TRI_AND_PROOF = Proof(
    InferenceRule([Formula.parse('p'), Formula.parse('q'), Formula.parse('r')],
                  Formula.parse('(r&(p&q))')),
    {R8},
    [Proof.Line(Formula.parse('p')),
     Proof.Line(Formula.parse('q')),
     Proof.Line(Formula.parse('(p&q)'), R8, [0,1]),
     Proof.Line(Formula.parse('r')),
     Proof.Line(Formula.parse('(r&(p&q))'), R8, [3, 2])])
...
#    from tautology import encode_as_formula
