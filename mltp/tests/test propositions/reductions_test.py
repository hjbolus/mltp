...
# File name: propositions/reductions_test.py

"""Tests for the propositions.reductions module."""
...
TEST_GRAPHS = [
    ...
    #((6, frozenset({(1,2), (2,3), (3,4), (4,5), (5,1), (1,6), (2,6), (3,6), (4,6), (5,6)})), False)]# 5-cycle + vertex
